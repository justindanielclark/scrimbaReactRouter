  ...
  return (
    <main className="flex-1 overflow-x-hidden">
      <div className="max-w-5xl mx-auto">
        <h2 className="font-bold text-xl py-4">Explore our van options:</h2>
        <Suspense fallback={<div>Loading Vans From Server...</div>}>
